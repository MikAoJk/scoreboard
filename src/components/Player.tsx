...
const Player = (playerProps: PlayerProps) => {
    ...
    return (
        <ul className="mt-2 flex border-solid border-white border-2">
            ...
            <li className="w-1/6">{playerProps.playerData.score}</li>
            ...
            <li className="w-1/4 text-right mr-2">
                <button onClick={onSaveRemovePlayerHandler} type="button" className="bg-red-700 rounded font-bold py-2 px-4">Remove
                </button>
            </li>
        </ul>
    )
