...
const Player = (playerProps: PlayerProps) => {
    ...
    return (
        <ul className="mt-2 flex border-solid border-white border-2">
            <li className="w-1/5 text-left ml-2">{playerProps.playerData.name}</li>
            ...
            <li className="w-1/4 text-right">
                <button onClick={onSaveRemovePlayerHandler} type="button" className="bg-red-700 rounded font-bold md:py-2 md:px-2">Remove
                </button>
            </li>
        </ul>
    )
